...
public class AdminBoardVO {
	...
	public Date getCboard_date() {
		return cboard_date;
	}

	public void setCboard_date(Date cboard_date) {
	...
	public AdminBoardVO(int cboard_id, String cboard_title, String cboard_con, Date cboard_date, String writer_cid,
			int store_id) {
		this.cboard_id = cboard_id;
		this.cboard_title = cboard_title;
		this.cboard_con = cboard_con;
